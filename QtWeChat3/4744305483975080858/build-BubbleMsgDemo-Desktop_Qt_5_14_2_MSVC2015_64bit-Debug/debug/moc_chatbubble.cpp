...
#include <memory>
#include "../../BubbleMsgDemo/chatbubble.h"
...
QT_MOC_LITERAL(15, 176, 18) // "SltTextMenuClicked"
    ...
    "SltFileMenuClicked\0QAction*\0action\0"
    "SltTextMenuClicked"
};
#undef QT_MOC_LITERAL
...
void BubbleListPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->SltTextMenuClicked((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        switch (_id) {
